...
function LiveMatchesTable(props) {
  ...
  const handleRowClick = (match) => {
    ...
    if (match.HomeTeam && match.AwayTeam && match.MatchKey) {
      props.history.push(`/matchesh2h/${match.MatchKey}`)
    }
  }
            ...
            {uniqueTours.map((eachTour, index) => (
              <Fragment key={index}>
                ...
                <TableRow hover key={eachTour.League} style={{ background: "#A2DBFA" }} >
                  <TableCell className={classes.root} style={{ fontWeight: "bold" }} colSpan={4}>
                  ...
                  <Hidden smDown>
                    <TableCell align="center" className={classes.root}>Possesion</TableCell>
                  </Hidden>
                  <Hidden mdUp>
                    <TableCell align="center" className={classes.root}>Attacks</TableCell>
                  </Hidden>
                  <Hidden smDown>
                    <TableCell align="center" className={classes.root}>DangerousAttacks</TableCell>
                  </Hidden>
                  <Hidden mdUp>
                    <TableCell align="center" className={classes.root}>Attempts</TableCell>
                  </Hidden>
                  <Hidden smDown>
                    <TableCell align="center" className={classes.root}>GoalAttempts</TableCell>
                  </Hidden>
                  <Hidden mdUp>
                    <TableCell align="center" className={classes.root}>Red</TableCell>
                  </Hidden>
                  <Hidden smDown>
                    <TableCell align="center" className={classes.root}>Red Cards</TableCell>
                  </Hidden>
